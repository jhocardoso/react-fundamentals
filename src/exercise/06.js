...
function UsernameForm({ onSubmitUsername }) {
    ...
    // set Msg -> função de atualização da variável de estado
    // A função useState aceita um parâmetro que é o VALOR INICIAL da variável
    // de estado. Ou seja, nesse caso, msg tem um valor inicial de string vazia.

    // useState() retorn um vetor que normalmente é recebido via desestruturação
