...
//const mediumBox = <div div className="box box--medium" style={ { backgroundColor: 'pink', fontStyle: 'italic'} }>medium pink box</div>
//const largeBox = <div div className="box box--large" style={ { backgroundColor: 'orange', fontStyle: 'italic'} }>large orange box</div>
  ...
  return (
    <div>
        {/*
            ...
            os nosmes das propriedades do objeto, mas escritas em camelCase.
